...
- **Keyboard and mouse devices, plus observable transfer counts.** The terminal now reports its
  buffered-byte level, the bytes a block read actually moved, and the input it dropped to a full
