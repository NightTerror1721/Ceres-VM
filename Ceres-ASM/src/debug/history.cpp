...
namespace ceres::debug
{
	...
	void History::start(const vm::CeresVM& machine, const vm::TimerDevice& timer, const vm::TerminalDevice& terminal)
	{
		clear();
		_enabled = true;
	...
	bool History::maybeSnapshot(const vm::CeresVM& machine, const vm::TimerDevice& timer,
	...
	std::optional<u64> History::restoreNearest(u64 tick, vm::CeresVM& machine, vm::TimerDevice& timer,
