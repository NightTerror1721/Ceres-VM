...
| F1.7 | Bus de 32 bits: `read`/`write` y `FaultReason` | F1.6 | DONE | asm@192f124 |
...
| F2.3 | Todos los dispositivos al planificador; halt por eventos | F2.2 | DONE | asm@2a4f154 |
...
| F2.9 | Test de determinismo y documentación | F2.6, F2.8 | DONE | asm@42bec94 |
