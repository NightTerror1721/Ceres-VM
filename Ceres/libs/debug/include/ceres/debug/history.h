...
#include <ceres/core/isa/registers.h>
...
namespace ceres::debug
{
	...
	public:
		...
		void start(const CeresVM& machine, const TimerDevice& timer, const TerminalDevice& terminal);
		void clear();
		...
		bool maybeSnapshot(const CeresVM& machine, const TimerDevice& timer,
		...
		std::optional<u64> restoreNearest(u64 tick, CeresVM& machine, TimerDevice& timer, TerminalDevice& terminal);
