	...
	private:
		...
		static constexpr Entry describe(Opcode opcode) noexcept
		{
			switch (opcode)
			{
				...
				case Opcode::MULH:    return { "MULH",    Shape::RdRsRt };
				case Opcode::IMULH:   return { "IMULH",   Shape::RdRsRt };
				case Opcode::MIN:     return { "MIN",     Shape::RdRsRt };
				case Opcode::IMIN:    return { "IMIN",    Shape::RdRsRt };
				case Opcode::MAX:     return { "MAX",     Shape::RdRsRt };
				case Opcode::IMAX:    return { "IMAX",    Shape::RdRsRt };
				case Opcode::ROL:     return { "ROL",     Shape::RdRsRt };
				case Opcode::ROR:     return { "ROR",     Shape::RdRsRt };
				case Opcode::MINI:    return { "MINI",    Shape::RdRsImm16 };
	...
	public:
		...
		static std::string disassemble(Instruction instruction)
		{
			...
			switch (entry.shape)
			{
				...
				case Shape::RdSimm20:   return std::format("{} r{}, {}{}", entry.name, rd, instruction.simm20() < 0 ? "" : "+", instruction.simm20());
