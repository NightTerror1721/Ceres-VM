...
// The glyphs the text framebuffer is drawn with in a window: printable ASCII, 32 to 126, as the classic 5x7
// dot-matrix shapes. Seven rows of a byte per glyph, top to bottom, bit 0 the LEFTMOST of five dots. They are
// the same shapes as the standard library's pixel font (ceres/font.h, generated by its tools/gen_font.js), so
// text in the window and text a program draws itself look alike. text_renderer.h stretches them to a cell.
//
// Generated from that library's font_data.inc; regenerate rather than edit.

#include <ceres/core/base/types.h>

namespace ceres::devices
{
	inline constexpr u8 TextFontGlyphs[95][7] = {
