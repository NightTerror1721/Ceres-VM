...
namespace ceres::casm
{
	...
	static std::unordered_map<InstructionSignature, InstructionInfo> __instructionsInfoMap
	{
		...
		inst(Opcode::MCPY, Mnemonic::MCPY, OpcodeParameterType::RD, OpcodeParameterType::RS, OpcodeParameterType::RT),
		inst(Opcode::MSET, Mnemonic::MSET, OpcodeParameterType::RD, OpcodeParameterType::RS, OpcodeParameterType::RT),
		inst(Opcode::MCMP, Mnemonic::MCMP, OpcodeParameterType::RD, OpcodeParameterType::RS, OpcodeParameterType::RT),
		inst(Opcode::MSCAN, Mnemonic::MSCAN, OpcodeParameterType::RD, OpcodeParameterType::RS, OpcodeParameterType::RT),
