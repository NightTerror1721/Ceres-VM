...
namespace ceres::casm
{
	...
	private:
		...
		std::optional<Address> _address; // Address in program memory where the statement will be located (set during assembly)
	...
	public:
		...
		constexpr Address address() const noexcept { return _address.value(); }
	...
	public:
		...
		static RelocatableStatement makePadding(std::string_view file, u32 line, u32 size, Address address) noexcept
		{
		...
		static RelocatableStatement makeLabel(std::string_view file, u32 line, Address address, LabelStatement&& label) noexcept
		{
		...
		static RelocatableStatement makeData(std::string_view file, u32 line, u32 size, Address address, ResolvedDataStatement&& data) noexcept
		{
		...
		static RelocatableStatement makeInstruction(std::string_view file, u32 line, u32 size, Address address, InstructionStatement&& instruction) noexcept
		{
